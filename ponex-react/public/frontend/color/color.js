$(function () {
	...
	$('.js-settings-panel hidden-btn').on('click',function (e){
		var $this = $(this).parent('.js-settings-panel hidden-item');
		$('.js-settings-panel hidden-item').not($this).removeClass('opened');
